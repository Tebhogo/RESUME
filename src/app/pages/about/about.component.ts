          ...
          <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div class="flex flex-col md:flex-row items-center md:items-start gap-8 mb-8">
              ...
              <div class="flex-1 text-center md:text-left">
                ...
                <p class="text-xl text-orange-500 mb-4">Full Stack Software Engineer & Data Engineer</p>
                <div class="space-y-2 text-gray-600">
                  ...
                  <p class="flex items-center justify-center md:justify-start">
                    <svg class="w-5 h-5 mr-2 text-orange-500" fill="currentColor" viewBox="0 0 24 24">
                      <path fill-rule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.021c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.021C22 6.484 17.522 2 12 2z" clip-rule="evenodd"/>
                    </svg>
                    <a href="https://github.com/Tebhogo" target="_blank" rel="noopener noreferrer" class="hover:text-orange-500 transition-colors">
                      GitHub Profile
                    </a>
                  </p>
                </div>
            ...
            <div class="border-t pt-8">
              ...
              <p class="text-gray-700 leading-relaxed text-lg mb-6">
                Full stack software engineer and data engineer with 7+ years of experience across retail IT, enterprise development, and fintech. Currently at ANGWA PAY, building secure payment gateway systems with integrations for EcoCash, Omari, InnBucks, and ZimSwitch. Previously at OK Zimbabwe as Programming Analyst, where I developed the Stock Take app, created 30+ operational reports, configured Power BI Reporting Server, and designed MSSQL databases. Skilled in Java Spring, Python, SQL, Power BI, Angular, and Flutter — with a strong focus on scalable APIs, data pipelines, and business intelligence.
              </p>
                ...
                <div class="space-y-6">
                  ...
                  <div class="bg-white border-l-4 border-orange-500 p-6 rounded-lg shadow-md">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                      <div>
                        <h4 class="text-xl font-bold text-black">ANGWA PAY</h4>
                        <p class="text-lg text-orange-500 font-semibold">Software Engineer</p>
                      </div>
                      <span class="text-gray-600 font-medium mt-2 md:mt-0">MAY 2026 - PRESENT</span>
                    </div>
                    <ul class="text-gray-700 space-y-2 list-disc list-inside">
                      <li>Develop and maintain secure, scalable frontend and backend systems for AngwaPay payment gateway platform.</li>
                      <li>Build REST APIs, payment integrations, and transaction processing for EcoCash, Omari, InnBucks, and ZimSwitch.</li>
                      <li>Implement merchant wallets, automated status updates, and secure authentication for financial operations.</li>
                      <li>Design and maintain SQL databases supporting payment collection, deposits, withdrawals, and reporting.</li>
                    </ul>
                  </div>

                  <!-- OK Zimbabwe - Programming Analyst -->
                  <div class="bg-white border-l-4 border-orange-500 p-6 rounded-lg shadow-md">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                      <div>
                        <h4 class="text-xl font-bold text-black">OK Zimbabwe</h4>
                        <p class="text-lg text-orange-500 font-semibold">Programming Analyst</p>
                      </div>
                      <span class="text-gray-600 font-medium mt-2 md:mt-0">AUG 2022 - APR 2026</span>
                    </div>
                    <ul class="text-gray-700 space-y-2 list-disc list-inside">
                      <li>Designed and developed the Stock Take application using Java Spring and Flutter with 30+ data-driven reports.</li>
                      <li>Built and maintained Power BI dashboards for sales, order fill rates, and KPI monitoring.</li>
                      <li>Configured Power BI Reporting Server and designed MSSQL databases for enterprise reporting.</li>
                      <li>Created 30+ custom operational and analytical reports across multiple departments.</li>
                      <li>Developed and optimized SQL queries; collaborated with stakeholders on data-driven process improvements.</li>
                    </ul>
                  </div>

                  <!-- OK Zimbabwe - IT Support -->
                  <div class="bg-white border-l-4 border-orange-500 p-6 rounded-lg shadow-md">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                      <div>
                        <h4 class="text-xl font-bold text-black">OK Zimbabwe</h4>
                        <p class="text-lg text-orange-500 font-semibold">IT Support Specialist</p>
                      </div>
                      <span class="text-gray-600 font-medium mt-2 md:mt-0">FEB 2020 - JUL 2022</span>
                    </div>
                    <ul class="text-gray-700 space-y-2 list-disc list-inside">
                      <li>Monitored and maintained retail IT systems for inventory, sales, customer transactions, and operations.</li>
                      <li>Installed and configured hardware, software, networks, printers, and user accounts.</li>
                      <li>Provided in-person and remote support; conducted system updates, backups, and staff training.</li>
                      <li>Collaborated on IT policies and procedures for retail technology environments.</li>
                    </ul>
                  </div>
                  ...
                  <div class="bg-white border-l-4 border-orange-500 p-6 rounded-lg shadow-md">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                      ...
                      <span class="text-gray-600 font-medium mt-2 md:mt-0">JAN 2019 - FEB 2020</span>
                    </div>
                    <ul class="text-gray-700 space-y-2 list-disc list-inside">
                      <li>Managed help desk tickets and resolved hardware and software issues for retail operations.</li>
                      <li>Conducted operating system installations and network troubleshooting.</li>
                      <li>Maintained database records, security audits, and end-user training and support.</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-8">
                ...
                <div class="space-y-4">
                  <div class="bg-white border-l-4 border-orange-500 p-5 rounded-lg shadow-md">
                    <h4 class="text-lg font-bold text-black mb-1">Explore Core Data Concepts</h4>
                    <p class="text-gray-600">Microsoft Learn</p>
                    <p class="text-gray-500 text-sm">2026</p>
                  </div>

                  <div class="bg-white border-l-4 border-orange-500 p-5 rounded-lg shadow-md">
                    <h4 class="text-lg font-bold text-black mb-1">Introduction to Data Engineering on Azure</h4>
                    <p class="text-gray-600">Microsoft Learn</p>
                    <p class="text-gray-500 text-sm">2025</p>
                  </div>

                  <div class="bg-white border-l-4 border-orange-500 p-5 rounded-lg shadow-md">
                    <h4 class="text-lg font-bold text-black mb-1">CompTIA Cloud Basic</h4>
                    <p class="text-gray-600">Alison Online</p>
                    <p class="text-gray-500 text-sm">2025</p>
                  </div>

                  <div class="bg-white border-l-4 border-orange-500 p-5 rounded-lg shadow-md">
                    <h4 class="text-lg font-bold text-black mb-1">Databricks Fundamentals</h4>
                    <p class="text-gray-600">Databricks Academy</p>
                    <p class="text-gray-500 text-sm">2025</p>
                  </div>
                ...
                <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white border-l-4 border-orange-500 rounded-lg p-5 shadow-md">
                      ...
                      <p class="text-gray-600 text-sm mb-2">Angular, Flutter, HTML/CSS/JavaScript, Payment Gateway Integration, Mobile & Web Development</p>
                    </div>
...
export class AboutComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get<any[]>('assets/data/projects.json').subscribe(projects => {
      ...
      this.majorProjects = [
        projects.find(p => p.id === 10), // AngwaPay Payment Gateway
        projects.find(p => p.id === 1),  // Stock Take App
        projects.find(p => p.id === 11), // CCTN POS
