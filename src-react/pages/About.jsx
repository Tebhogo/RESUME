...
function About() {
  ...
  useEffect(() => {
    ...
    fetch('/RESUME/data/projects.json')
      ...
      .then(data => {
        setMajorProjects([
          data.find(p => p.id === 10), // AngwaPay Payment Gateway
          data.find(p => p.id === 1),  // Stock Take App
          data.find(p => p.id === 11), // CCTN POS
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-xl text-orange-500 mb-4">Full Stack Software Engineer & Data Engineer</p>
                <div className="space-y-2 text-gray-600">
                  ...
                  <p className="flex items-center justify-center md:justify-start">
                    <svg className="w-5 h-5 mr-2 text-orange-500" fill="currentColor" viewBox="0 0 24 24">
                      <path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.021c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.021C22 6.484 17.522 2 12 2z" clipRule="evenodd"/>
                    </svg>
                ...
                <div className="space-y-6">
                  <div className="bg-white border-l-4 border-orange-500 p-6 rounded-lg shadow-md">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                      <div>
                        <h4 className="text-xl font-bold text-black">ANGWA PAY</h4>
                        <p className="text-lg text-orange-500 font-semibold">Software Engineer</p>
                      </div>
                      <span className="text-gray-600 font-medium mt-2 md:mt-0">MAY 2026 - PRESENT</span>
                    </div>
                  ...
                  <div className="bg-white border-l-4 border-orange-500 p-6 rounded-lg shadow-md">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                      <div>
                        ...
                        <p className="text-lg text-orange-500 font-semibold">Programming Analyst</p>
                      </div>
                      <span className="text-gray-600 font-medium mt-2 md:mt-0">AUG 2022 - APR 2026</span>
                    </div>
                    <ul className="text-gray-700 space-y-2 list-disc list-inside">
                  ...
                  <div className="bg-white border-l-4 border-orange-500 p-6 rounded-lg shadow-md">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                      <div>
                        <h4 className="text-xl font-bold text-black">OK Zimbabwe</h4>
                        <p className="text-lg text-orange-500 font-semibold">IT Support Specialist</p>
                      </div>
                      <span className="text-gray-600 font-medium mt-2 md:mt-0">FEB 2020 - JUL 2022</span>
                    </div>
                    <ul className="text-gray-700 space-y-2 list-disc list-inside">
                  ...
                  <div className="bg-white border-l-4 border-orange-500 p-6 rounded-lg shadow-md">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                      ...
                      <span className="text-gray-600 font-medium mt-2 md:mt-0">JAN 2019 - FEB 2020</span>
                    </div>
                    <ul className="text-gray-700 space-y-2 list-disc list-inside">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  <div className="bg-white border-l-4 border-orange-500 p-5 rounded-lg shadow-md">
                    <h4 className="text-lg font-bold text-black mb-1">Explore Core Data Concepts</h4>
                    <p className="text-gray-600">Microsoft Learn</p>
                    <p className="text-gray-500 text-sm">2026</p>
                  </div>

                  <div className="bg-white border-l-4 border-orange-500 p-5 rounded-lg shadow-md">
                    <h4 className="text-lg font-bold text-black mb-1">Introduction to Data Engineering on Azure</h4>
                    <p className="text-gray-600">Microsoft Learn</p>
                    <p className="text-gray-500 text-sm">2025</p>
                  </div>

                  <div className="bg-white border-l-4 border-orange-500 p-5 rounded-lg shadow-md">
                    <h4 className="text-lg font-bold text-black mb-1">CompTIA Cloud Basic</h4>
                    <p className="text-gray-600">Alison Online</p>
                    <p className="text-gray-500 text-sm">2025</p>
                  </div>

                  <div className="bg-white border-l-4 border-orange-500 p-5 rounded-lg shadow-md">
                    <h4 className="text-lg font-bold text-black mb-1">Databricks Fundamentals</h4>
                    <p className="text-gray-600">Databricks Academy</p>
                    <p className="text-gray-500 text-sm">2025</p>
                  </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white border-l-4 border-orange-500 rounded-lg p-5 shadow-md">
                      ...
                      <p className="text-gray-600 text-sm mb-2">Angular, Flutter, HTML/CSS/JavaScript, Payment Gateway Integration, Mobile & Web Development</p>
                    </div>
